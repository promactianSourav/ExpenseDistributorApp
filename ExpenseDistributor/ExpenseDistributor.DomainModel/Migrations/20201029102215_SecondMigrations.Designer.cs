...
namespace ExpenseDistributor.DomainModel.Migrations
{
    ...
    [Migration("20201029102215_SecondMigrations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExpenseDistributor.DomainModel.Models.Expense", b =>
                {
                    ...
                    b.HasOne("ExpenseDistributor.DomainModel.Models.User", "DebtUser")
                        .WithMany("DebtUserExpense")
                    ...
                    b.HasOne("ExpenseDistributor.DomainModel.Models.User", "PayerUser")
                        .WithMany("PayerUserExpense")
            ...
            modelBuilder.Entity("ExpenseDistributor.DomainModel.Models.Settlement", b =>
                {
                    ...
                    b.HasOne("ExpenseDistributor.DomainModel.Models.User", "DebtUser")
                        .WithMany("DebtUserSettlement")
                        .HasForeignKey("DebtUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("ExpenseDistributor.DomainModel.Models.User", "PayerUser")
                        .WithMany("PayerUserSettlement")
                        .HasForeignKey("PayerUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("ExpenseDistributor.DomainModel.Models.SettlementPerExpense", b =>
                {
                    ...
                    b.HasOne("ExpenseDistributor.DomainModel.Models.User", "DebtUser")
                        .WithMany("DebtUserSettlementPerExpense")
                        .HasForeignKey("DebtUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                    ...
                    b.HasOne("ExpenseDistributor.DomainModel.Models.User", "PayerUser")
                        .WithMany("PayerUserSettlementPerExpense")
                        .HasForeignKey("PayerUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("ExpenseDistributor.DomainModel.Models.TotalExpensesPerRelationship", b =>
                {
                    b.HasOne("ExpenseDistributor.DomainModel.Models.User", "DebtUser")
                        .WithMany("DebtUserTotalExpensesPerRelationship")
                        .HasForeignKey("DebtUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("ExpenseDistributor.DomainModel.Models.User", "PayerUser")
                        .WithMany("PayerUserTotalExpensesPerRelationship")
                        .HasForeignKey("PayerUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                });
